...
from adhoccomputing.DistributedAlgorithms.MutualExclusion.Raymond import MutualExclusionRaymondComponent
...
def main():
    ...
    topology.construct_from_graph(G, MutualExclusionRaymondComponent, GenericChannel)
    topology.start()
